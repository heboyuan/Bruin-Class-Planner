...
function grade_dist_graph(score_data, node_id) {
  var arr = [
    ["Grade Type", "Percentage", {role:'style'}, {role:'annotation'}, {role:'tooltip'}]
  ];
  for (var score in score_data){
    arr.push([score, score_data[score]/100, 'orange', String(score_data[score])+'%', score +'\n'+ String(score_data[score])+'%']);
  }
